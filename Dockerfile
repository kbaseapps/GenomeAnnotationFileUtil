...
RUN mkdir -p /kb/module && cd /kb/module && git clone -b develop https://github.com/kbase/data_api && \
    cd data_api && git checkout 0.3.1-dev && cd /kb/module && \
...
RUN mkdir -p /kb/module && cd /kb/module && git clone -b develop https://github.com/kbase/transform && \
    cd transform && git checkout 7a61cc4 && cd /kb/module && \
